...
NAVER search trend may add up to 10 points before the total is capped at 100. Treat every component as a transparent comparison aid, not a performance claim. Prefer candidates with a concrete public consequence and a question that can be answered in 12-35 seconds. Deprioritize a procedural announcement with no identified citizen effect, duplicated press-release coverage, a topic that needs more than ten seconds of setup, or a claim whose payoff remains unknown.
...
Present up to three qualified candidates and keep user selection mandatory. When evidence permits, make the set meaningfully different:
